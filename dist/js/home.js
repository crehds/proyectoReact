...
/******/ 	__webpack_require__.p = "C:\\Users\\USER\\Desktop\\RH\\proyecto react\\dist/";
/******/
/******/
...
// EXTERNAL MODULE: ./src/pages/components/home-layout.css
var home_layout = __webpack_require__(10);

// CONCATENATED MODULE: ./src/pages/components/Home-layout.jsx
...
/* harmony default export */ var Home_layout = (HomeLayout);
// CONCATENATED MODULE: ./src/errors/components/regular-error.jsx
...
/* harmony default export */ var regular_error = (RegularError);
// CONCATENATED MODULE: ./src/errors/containers/Handle-error.jsx
...
function (_Component) {
  ...
  function HandleError() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(HandleError)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(HandleError, [{
    ...
    value: function render() {
      if (this.state.handleError) {
        return react_default.a.createElement(regular_error, null);
      }
...
/* harmony default export */ var Handle_error = (Handle_error_HandleError);
// EXTERNAL MODULE: ./src/hero/components/hero-layout.css
var hero_layout = __webpack_require__(11);

// CONCATENATED MODULE: ./src/hero/components/hero-layout.jsx
...
/* harmony default export */ var components_hero_layout = (HeroLayout);
// EXTERNAL MODULE: ./src/hero/components/logo.css
var logo = __webpack_require__(12);

// CONCATENATED MODULE: ./src/hero/components/logo.jsx
...
function (_PureComponent) {
  logo_inherits(Logo, _PureComponent);
...
// EXTERNAL MODULE: ./src/hero/components/menu.css
var menu = __webpack_require__(13);

// CONCATENATED MODULE: ./src/hero/components/menu.jsx
...
function Menu(props) {
  return react_default.a.createElement("nav", {
    className: "menu"
  }, react_default.a.createElement("ul", null, props.menu.map(function (item) {
...
// EXTERNAL MODULE: ./src/hero/components/header-layout.css
var header_layout = __webpack_require__(14);

// CONCATENATED MODULE: ./src/hero/components/header-layout.jsx
...
/* harmony default export */ var components_header_layout = (HeaderLayout);
// EXTERNAL MODULE: ./src/slider/template.css
var template = __webpack_require__(15);

// CONCATENATED MODULE: ./src/slider/Template.jsx
...
function Template(props) {
  return react_default.a.createElement("div", {
    className: "template"
  }, react_default.a.createElement("div", null, react_default.a.createElement("p", null, "Contenido1")), react_default.a.createElement("div", null, react_default.a.createElement("p", null, "Contenido2")));
}

/* harmony default export */ var slider_Template = (Template);
// CONCATENATED MODULE: ./src/hero/containers/Hero.jsx
...
function (_Component) {
  ...
  Hero_createClass(Hero, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement(components_hero_layout, null, react_default.a.createElement(components_header_layout, null, react_default.a.createElement(components_logo, {
        src: this.props.header.imgIndustrial
      }), react_default.a.createElement(components_menu, {
        menu: this.props.header.menu
      }), react_default.a.createElement(components_logo, {
        src: this.props.header.imgClimatizacion
      })), react_default.a.createElement(slider_Template, null));
    }
  }]);
...
/* harmony default export */ var containers_Hero = (Hero_Hero);
// EXTERNAL MODULE: ./node_modules/React/index.js
var React = __webpack_require__(2);
var React_default = /*#__PURE__*/__webpack_require__.n(React);

// EXTERNAL MODULE: ./src/history/components/history-layout.css
var history_layout = __webpack_require__(17);

// CONCATENATED MODULE: ./src/history/components/history-layout.jsx
...
/* harmony default export */ var components_history_layout = (HistoryLayout);
// EXTERNAL MODULE: ./src/history/components/caja.css
var caja = __webpack_require__(18);

// CONCATENATED MODULE: ./src/history/components/Caja.jsx
...
function Caja(props) {
  return react_default.a.createElement("div", {
    className: "caja"
  }, react_default.a.createElement("h2", null, props.title));
}

/* harmony default export */ var components_Caja = (Caja);
// CONCATENATED MODULE: ./src/history/containers/History.jsx




function History(props) {
  return React_default.a.createElement(components_history_layout, null, console.log(props.history.data), props.history.data.map(function (item) {
    return React_default.a.createElement(components_Caja, {
      key: item.id,
      title: item.title
    });
  }));
...
function (_Component) {
  ...
  Home_createClass(Home, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement(Handle_error, null, react_default.a.createElement(Home_layout, null, react_default.a.createElement(containers_Hero, {
...
// CONCATENATED MODULE: ./src/entries/home.js




var homeContainer = document.getElementById('home-container');
Object(react_dom["render"])(react_default.a.createElement(containers_Home, {
  data: data
}), homeContainer);
